...
interface HeroSection {
    ...
    background_image: null | string |File
}
...
const submit = () => {
    form.post(`/home-hero/update/${props.hero.id}`, {
        forceFormData: true,
    });
};
...
onMounted(() => {
    ...
    $('#background_image').dropify({
        height: 150,
        defaultFile: props.hero.background_image,
        messages: {
            default: 'Drag and drop a file here or click',
            replace: 'Drag and drop or click to replace',
            remove: 'Remove',
...
<template>
    ...
    <Head title="Hero Section Edit" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="bg-white m-7 p-5 rounded">
            <!-- Header -->
            <div class="flex items-center justify-between border-b pb-3">
                <h1 class="text-xl font-medium">Hero Section Update</h1>
                <LinkButton label="Back" url="/home-hero" />
            </div>
                ...
                <form @submit.prevent="submit">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="file" id="background_image" @change="backgroundImage" class="dropify" />
                            <span class="text-red-500 text-sm" v-if="form.errors.background_image">{{

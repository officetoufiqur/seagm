                ...
                <form @submit.prevent="submit">
                    ...
                    <div class="mb-3 space-y-4">
                        <div class="grid grid-cols-2 gap-3">
                            <div>
                                <label for="card_id" class="text-[#5D5D5D] font-medium text-sm">Select Card</label>
                               <select name="card_id" id="card_id" v-model="form.card_id" class="border border-gray-300 rounded px-3 py-2 w-full mt-1 text-sm">

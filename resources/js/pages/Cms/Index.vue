...
const data = ref(props.cms);

</script>

<template>

    <Head title="About CMS" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <FlashMessage :message="props.flash.message" />
        <div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-7">
            <FilterTable :rows="data" :columns="columns" title="About CMS List" :create-btn="true" create-text="Create" create-url="/about-cms/create">
                ...
                <template #action="{ item }">
                    <div class="flex items-center gap-2">
                        <Link :href="`/about-cms/edit/${item.id}`"

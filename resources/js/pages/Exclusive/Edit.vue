...
const submit = () => {
    form.post('/exclusive-offers/update/' + props.exclusiveOffer.id, {
        onSuccess: () => {
            form.reset();
        }
    });
...
const mainDropify = () => {
    $('.dropify').dropify({
        defaultFile: props.exclusiveOffer.image,
        height: 150,
        messages: {
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="bg-white m-7 p-5 rounded">
            ...
            <div class="flex items-center justify-between border-b pb-3">
                <h1 class="text-xl font-medium">Exclusive offers Edit</h1>
                <LinkButton label="Back" url="/exclusive-offers" />
            </div>

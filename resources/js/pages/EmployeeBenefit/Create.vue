...
const submit = () => {
    form.post('/employee-benefits/store', {
        onSuccess: () => {
            form.reset();
        }
    });
                    ...
                    <div class="mb-3 space-y-4">
                        <div class="grid grid-cols-2 gap-3">
                            ...
                            <div>
                                ...
                                <textarea name="" id="content" v-model="form.description" rows="5" class="border border-gray-300 rounded px-3 py-2 w-full mt-1 text-sm"></textarea>
